...
public class SimpsonMethod {
    ...
    public SimpsonMethod(org.mariuszgromada.math.mxparser.Function function, double inferiorLimitValue, double superiorLimitValue, double nSubintervalsValue){
    ...
    public double calculateSimpsonMethod(){
        ...
        while (inferiorLimitValue  <= superiorLimitValue){
            if (counter == 0) {
                ...
                Expression expression = new Expression( "At(" + inferiorLimitValue + ")" , simpsonMethodFunction);
                result =  (( 4 * expression.calculate()) + result );
                System.out.println(result);
            } else if( counter%2 == 0 ){
                Expression expression = new Expression("At(" + inferiorLimitValue + ")", simpsonMethodFunction);
